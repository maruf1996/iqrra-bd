    ...
    <div>
        ...
        <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-12 lg:flex-row lg:justify-between lg:px-20">
          <div className="flex flex-col justify-center p-6 rounded-sm lg:max-w-[50%]">
            ...
            <p className="my-8 text-1xl">
              বইপ্রেমীদের জন্য ইক্বরা বিডি একটি জনপ্রিয় অনলাইন লাইব্রেরী। ইক্বরা
              বিডি নিয়ে এসেছে অনলাইনে বইয়ের বিশাল সমারহ। ইক্বরা বিডি চেষ্টা করে
              যাচ্ছে তার পাঠকদের জন্য ব্যতিক্রমী কিছু উপহার দেওয়ার।
            </p>
            <p className="text-1xl">
              বিভিন্ন লেখক ও বিভিন্ন ক্যাটাগরীর বিভিন্ন বই নির্বিগ্নে যেন পাঠক
              পড়তে পারে এজন্যই জন্ম হয়েছে ইক্বরা বিডির। আপনারা আমাদের পাশে থাকলে
              আমরা চেষ্টা করবো আমাদের সর্বোচ্চ পরিশ্রম ও ত্যাগের মাধ্যমে আরো
              ভালো কিছু আপনাদের উপহার দিতে।
            </p>
          </div>
      ...
      <section className="text-gray-800 bg-gray-50">
        <div className="grid grid-cols-1 lg:grid-cols-2 py-12 px-4 lg:px-16 gap-8">
          <div className="card shadow-md p-8 lg:w-[80%] mx-auto bg-white">
            <h1 className="text-3xl font-bold mb-4 text-center">
              বিশেষ আবেদন!
            </h1>
            <p className="text-justify font-bold ">
              ইক্বরা বিডির ওয়েবসাইটটিতে এখনো ডোমেইন হোস্টিংসহ অনেক কাজ চলমান।
              এসমস্ত কাজ বিশেষ করে ডোমেইন হোস্টিং এর জন্য ভালো পরিমাণে আমাদের
              অর্থের প্রয়োজন। আশাকরি ইক্বরা বিডির পাঠকরা আমাদের যথাসাধ্য
              সহযোগিতা করবেন।
            </p>
          </div>
          <div className="card p-8 lg:w-[80%] mx-auto">
